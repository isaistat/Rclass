...
| Term | Simple Meaning |
|-----|---------------|
| function | A command that does something (always has `()`) |
| argument | Extra options given to a function |
| base R | The default R installation |
| class | The type of data (number, text, TRUE/FALSE) |
